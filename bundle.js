	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                this.state.tasks.map(function (task, i) {
	                    var c = i % 4;
	                    return _react2.default.createElement(_card2.default, _extends({}, task, { color: _this2.state.colors[c] }));
	                })
	            );
	        }
	    }]);
	...
	var Card = function (_Component) {
	    ...
	    _createClass(Card, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: "card " + color, onClick: function onClick() {
	                        _this2.handleClick(url);
	                    } },
