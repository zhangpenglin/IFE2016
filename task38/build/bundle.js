	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_table2.default, this.props)
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sort = function (_Component) {
	    ...
	    function Sort(props) {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Sort).call(this, props));
	    }
	    ...
	    _createClass(Sort, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement('div', { className: 'triangle', onClick: this.props.ascSort }),
	                _react2.default.createElement('div', { className: 'triangle_transform', onClick: this.props.descSort })
	            );
	        }
	    }]);
	...
	var Table = function (_Component2) {
	    ...
	    _createClass(Table, [{
	        key: 'ascSort',
	        value: function ascSort(index) {
	            this.props.actions.ascSort(index);
	        }
	    }, {
	        key: 'descSort',
	        value: function descSort(index) {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'tr',
	                        null,
	                        head.map(function (n, k) {
	                            return _react2.default.createElement(
	                                'th',
	                                null,
	                                n.get('title'),
	                                n.get("sort") && _react2.default.createElement(Sort, { ascSort: _this3.ascSort.bind(_this3, k), descSort: _this3.descSort.bind(_this3, k) })
	                            );
	                        })
	                    )
	                ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var initialState = Immutable.fromJS({
	    ...
	    body: [['小明', 80, 90, 70, 240], ['小红', 90, 60, 90, 240], ['小亮', 60, 100, 70, 230]]
	});
	function sort() {
